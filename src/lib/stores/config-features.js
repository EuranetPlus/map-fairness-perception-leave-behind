export const config = {
	mapTitle: 'map-fairness-perception-leave-behind', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'map-fairness-perception-leave-behind.vercel.app', // The url provided when deploying the map on Vercel
